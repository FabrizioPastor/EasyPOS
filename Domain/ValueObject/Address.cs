...
{
    public Address(string country, string line1, string line2, string city, string zipCode, string state)
    {
        Country = country;
        Line1 = line1;
        Line2 = line2;
    ...
    public static Address? Create(string country, string line1, string line2, string city, string state, string zipCode)
    {
        if (string.IsNullOrEmpty(country) || string.IsNullOrEmpty(line1) ||
            ...
            return null;
        return new Address(country, line1, line2, city, zipCode, state);
    }
}